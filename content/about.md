...
Second Brain is an eye-opening concept (at least for me), which underlines the fact that **the human brain is for creating ideas, not for storing them.** This really makes sense; who knows how many ideas you had that got forgotten without a second thought? So the solution is to put your newborn ideas somewhere accessible to come back to, and that gave birth to all of this. 

---

## What is going on here

This website is served by GitHub Pages from [my repository](https://github.com/demetrebadzaradze/Second-brain), and that is set up in such a way that, when local notes get pushed, they get pretty and show up on the site, like this page, which was just a note on my phone turned into this webpage. With [Obsidian](https://obsidian.md) integration this is even simpler.
